...
var DeletedText = /** @class */ (function (_super) {
    __extends(DeletedText, _super);
    function DeletedText(text) {
        var _this = _super.call(this, "w:delText") || this;
        _this.root.push(new text_attributes_1.TextAttributes({ space: shared_1.SpaceType.PRESERVE }));
        _this.root.push(text);
        return _this;
    }
    return DeletedText;
