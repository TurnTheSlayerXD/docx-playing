...
var MathLimitLower = /** @class */ (function (_super) {
    __extends(MathLimitLower, _super);
    function MathLimitLower(options) {
        var _this = _super.call(this, "m:limLow") || this;
