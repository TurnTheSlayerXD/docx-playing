...
exports.createFontTable = void 0;
var xml_components_1 = require("@file/xml-components");
var create_regular_font_1 = require("./create-regular-font");
var createFontTable = function (fonts) {
    ...
    return new xml_components_1.BuilderElement({
        ...
        children: fonts.map(function (font, i) {
            return (0, create_regular_font_1.createRegularFont)({
                name: font.name,
                index: i + 1,
